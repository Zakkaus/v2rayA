...
// The http tab of the node editor. Contract: the model comes in by
...
import type { HttpModel } from "../models";
import PendingForm from "../PendingForm.vue";

defineModel<HttpModel>({ required: true });
defineProps<{ readonly?: boolean }>();
</script>

<template>
  <PendingForm protocol="http" />
</template>
